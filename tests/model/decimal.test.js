...
describe("propertyInFocus: operand_1", () => {
    ...
    it("should append a decimal to operand_1 when the display has a negative but does not have a decimal", () => {
    ...
    it("should do nothing when the display has a decimal and a negative", () => {
        const calculator = new FourFunctionCalculator("operand_1", "-0.", null, null);
        calculator.makeInput(".");
        expect(calculator.propertyInFocus).toEqual("operand_1");
        expect(calculator.operand_1).toEqual("-0.");
